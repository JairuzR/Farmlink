...
@section('content')
<section class="bg-emerald-50 min-h-screen py-16">
    <div class="mx-auto max-w-md px-4 sm:px-6">

        {{-- Header --}}
        <div class="mb-8 text-center">
            <h1 class="text-4xl font-bold text-slate-950">Welcome back</h1>
            <p class="mt-3 text-slate-600">Sign in to your FARMLINK account</p>
        </div>
        ...
        <div class="rounded-2xl bg-white p-8 shadow-sm ring-1 ring-slate-200">
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-5">
                ...
                {{-- Submit --}}
                <button type="submit"
                    class="w-full rounded-lg bg-green-600 px-5 py-3 font-semibold text-white
            ...
            <div class="my-6 flex items-center gap-3">
                ...
                <span class="text-xs text-slate-400 font-medium">Don't have an account?</span>
                <div class="h-px flex-1 bg-slate-200"></div>
            </div>
